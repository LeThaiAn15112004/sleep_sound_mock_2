...
import com.example.sleepsound.databinding.ItemAmbiencePlayingBinding;
...
public class SoundPlayingAdapter extends RecyclerView.Adapter<SoundPlayingAdapter.SoundPlayingViewHolder> {
    ...
    @NonNull
    @Override
    public SoundPlayingAdapter.SoundPlayingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SoundPlayingAdapter.SoundPlayingViewHolder(itemAmbiencePlayingBinding);
    }

    @Override
    public void onBindViewHolder(@NonNull SoundPlayingAdapter.SoundPlayingViewHolder holder, int position) {
